...
public class FormationController {
    ...
    public void affectEtudiantToFormation(@PathVariable("etudiantId") Long etudiantId, @PathVariable("formationId") Integer formationId)     {
        User e = userRepository.findById(etudiantId).get();
        Formation f = FormationService.getFormationbyid(formationId);
          //List<Formation> form = FormationService.getAllFormation();
        //FormationRepository.save(f);
        List<User> listE = f.getUsers();
        listE.add(e);
        f.setUsers(listE);
        sendSMS();
        fr.save(f);
