...
public class CoursController {
    ...
    @Operation(summary = "Affect cours to formation", description = "affectCoursToFormation")
    @PutMapping(value = "/affectCoursToFormation/{nom}/{specialite}")
    @ResponseBody
    public Cours affectCoursToFormation(@RequestBody Cours c, @PathVariable("nom") String nom, @PathVariable("specialite") Specialite specialite) {
        return  CoursService.affectCoursToFormation(c, nom, specialite);

    }

    @Operation(summary = "findBySpecialite", description = "findBySpecialite ")
    @GetMapping("/findBySpecialite/{specialite}")

    public List<Cours> findBySpecialite( @PathVariable("specialite") Specialite specialite){

        return  CoursService.findBySpecialite(specialite);
    }
